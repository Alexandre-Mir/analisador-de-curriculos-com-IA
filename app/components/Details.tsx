			...
			<Accordion>
				<AccordionItem id="tone-style">
					<AccordionHeader itemId="tone-style">
						<CategoryHeader title="Tom & Estilo" categoryScore={feedback.toneAndStyle.score} />
					</AccordionHeader>
				...
				<AccordionItem id="content">
					<AccordionHeader itemId="content">
						<CategoryHeader title="Conteúdo" categoryScore={feedback.content.score} />
					</AccordionHeader>
				...
				<AccordionItem id="structure">
					<AccordionHeader itemId="structure">
						<CategoryHeader title="Estrutura" categoryScore={feedback.structure.score} />
					</AccordionHeader>
				...
				<AccordionItem id="skills">
					<AccordionHeader itemId="skills">
						<CategoryHeader title="Habilidades" categoryScore={feedback.skills.score} />
					</AccordionHeader>
